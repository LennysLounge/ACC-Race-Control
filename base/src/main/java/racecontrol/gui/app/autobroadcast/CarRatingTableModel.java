 ...
 * @author Leonard
 */
public class CarRatingTableModel
        extends LiveTimingTableModel {

    private List<CarRating> entriesNew = new ArrayList<>();

    public CarRatingTableModel() {
    }

    public void setEntriesNew(List<CarRating> entriesNew) {
    ...
    public CarRating getEntryNew(int index) {
