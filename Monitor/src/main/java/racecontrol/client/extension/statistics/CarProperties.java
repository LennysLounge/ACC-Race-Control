...
public interface CarProperties {
    ...
    public final Key<Integer> CAR_ID = new Key(Integer.class);
    ...
    public final Key<Byte> CAR_MODEL = new Key(Byte.class);
    public final Key<DriverCategory> CATEGORY = new Key(DriverCategory.class);
    // Laps
